import 'package:demo1/src/models/sqlite_model.dart';
  ...
  SqliteBloc()
    ...
    on<SqliteEventInsert>((event, emit) async {
      try {
        ...
        navigatorState.currentContext!.read<SqliteBloc>().add(SqliteEventQuery());
      } catch (e) {
    ...
    on<SqliteEventQuery>((event, emit) async {
      try {
        ...
        emit(state.copyWith(status: SqliteStatus.success, historyArray: result));
      } catch (e) {
